...
function SecondSection() {
  return (
    <section className={styles.main}>
      <h2 className={styles.title}>How Otter PONZI Works</h2>
      <div className={styles.body}>
        <Card
          num={1}
          title="Treasury Revenue"
          subtitle="Bonds & LP fees"
          desc="Bond sales and LP Fees increase Otter's Treasury Revenue and lock in liquidity and help control PONZI supply"
          img={HowItWorks01}
        />
        <Card
          num={2}
          ...
          desc="Treasury inflow is used to increase Otter's Treasury Balance and back outstanding PONZI tokens and regulate staking APY"
          img={HowItWorks02}
          reverse
        />
        <Card
